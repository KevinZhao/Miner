...
public abstract class CommService
{
	...
	protected synchronized void setState(STATE state)
	{
		...
		mHandler.obtainMessage(MapsActivity.MESSAGE_STATE_CHANGE, state).sendToTarget();
	}
	...
	protected void connectionFailed()
	{
		...
		bundle.putString(MapsActivity.TOAST, mContext.getString(R.string.unabletoconnect));
		msg.setData(bundle);
	...
	protected void connectionLost()
	{
		...
		Message msg = mHandler.obtainMessage(MapsActivity.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putString(MapsActivity.TOAST, mContext.getString(R.string.connectionlost));
		msg.setData(bundle);
		mHandler.sendMessage(msg);
	}
	...
	protected void connectionEstablished(String deviceName)
	{
		...
		Message msg = mHandler.obtainMessage(MapsActivity.MESSAGE_DEVICE_NAME);
		Bundle bundle = new Bundle();
		bundle.putString(MapsActivity.DEVICE_NAME, deviceName);
		msg.setData(bundle);
		mHandler.sendMessage(msg);
